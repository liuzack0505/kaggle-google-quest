...
python train.py -model_name=siamese_bert -enable_loss_fn_weights && python finetune.py -model_name=siamese_bert -enable_loss_fn_weights
python train.py -model_name=siamese_xlnet -enable_loss_fn_weights && python finetune.py -model_name=siamese_xlnet -enable_loss_fn_weights
python train.py -model_name=double_albert -enable_loss_fn_weights && python finetune.py -model_name=double_albert -enable_loss_fn_weights
```

Enable AWP

```
python train.py -model_name=siamese_roberta -enable_awp && python finetune.py -model_name=siamese_roberta -enable_awp
python train.py -model_name=siamese_bert -enable_awp && python finetune.py -model_name=siamese_bert -enable_awp
python train.py -model_name=siamese_xlnet -enable_awp && python finetune.py -model_name=siamese_xlnet -enable_awp
...
python train.py -model_name=siamese_bert -enable_loss_fn_weights -enable_awp && python finetune.py -model_name=siamese_bert -enable_loss_fn_weights -enable_awp
python train.py -model_name=siamese_xlnet -enable_loss_fn_weights -enable_awp && python finetune.py -model_name=siamese_xlnet -enable_loss_fn_weights -enable_awp
