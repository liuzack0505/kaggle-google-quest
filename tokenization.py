...
def tokenize(df, pretrained_model_str='bert-base-uncased'):
    ...
    tokenizer = tokenizers[pretrained_model_str].from_pretrained(
    ...
    for text, cols in [('question', ['question_title', 'question_body']),
        ...
        for x1, x2 in tqdm(df[cols].values):
            encoded_inputs = tokenizer.encode_plus(
                ...
                padding='max_length', truncation=True, return_token_type_ids=True, return_overflowing_tokens=False
            )
